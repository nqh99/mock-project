...
public class WebUtils {
	...
	public static void storeSessionCart(HttpSession session, Cart sessionCart) {
		session.setAttribute("sessionCart", sessionCart);
		System.out.println("Stored cart" + sessionCart.getId() + " to Session");
	}

	public static void removeSessionCart(HttpSession session, Cart sessionCart) {
		session.removeAttribute("sessionCart");
		System.out.println("Remove " + sessionCart.getId() + " from Session");
	}
